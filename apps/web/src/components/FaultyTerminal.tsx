...
export default function FaultyTerminal({
  ...
  useEffect(() => {
    ...
    gl.clearColor(lightMode ? 1 : 0, lightMode ? 1 : 0, lightMode ? 1 : 0, 0);
    gl.enable(gl.BLEND);
    ...
    let initialWidth = 2320;
    let initialHeight = 1440;

    function resize() {
      if (!ctn || !renderer) return;

      if (initialWidth < ctn.offsetWidth) initialWidth = ctn.offsetWidth;
      if (initialHeight < ctn.offsetHeight) initialHeight = ctn.offsetHeight;
